...
import com.mingweisamuel.zyra.matchList.MatchReference;
 ...
 * {@link com.mingweisamuel.zyra.MatchEndpoints} and
 * {@link com.mingweisamuel.zyra.MatchListEndpoints}.
 */
//TODO
public class ApiComboMatchMatchListTest extends ApiTest {

    @Test
    public void get() throws ExecutionException {
        MatchList matchList = api.matchlist.get(Region.NA, 51405, null, Collections.singleton(Queue.RANKED_SOLO_5x5),
                null, 1451606400000L);
        assertEquals(28, matchList.totalGames);
        assertEquals(28, matchList.matches.size());
        for (MatchReference matchRef : matchList.matches) {
