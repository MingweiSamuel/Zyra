 ...
 * BasicData.<br><br>
 *
 * This object contains basic data..<br><br>
 *
...
public class BasicData implements Serializable {
  ...
  public BasicData(final Gold gold, final String plaintext, final boolean hideFromAll,
      final boolean inStore, final List<String> into, final int id, final BasicDataStats stats,
      final String colloq, final Map<String, Boolean> maps, final int specialRecipe,
      final Image image, final String description, final List<String> tags,
      final String requiredChampion, final List<String> from, final String group,
      final boolean consumeOnFull, final String name, final boolean consumed,
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof BasicData)) return false;
