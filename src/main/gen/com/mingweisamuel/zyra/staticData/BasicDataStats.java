 ...
 *
 * This class was automatically generated from the <a href="https://developer.riotgames.com/api-methods/#static-data-v3/GET_getItemList">Riot API reference</a> on Wed May 17 21:34:50 PDT 2017. */
public class BasicDataStats implements Serializable {
  ...
  public BasicDataStats(final double rPercentMagicPenetrationModPerLevel,
      final double rFlatEnergyModPerLevel, final double PercentMagicDamageMod,
      final double PercentCritDamageMod, final double PercentSpellBlockMod,
      final double PercentHPRegenMod, final double PercentMovementSpeedMod,
      final double FlatSpellBlockMod, final double PercentHPPoolMod, final double FlatEnergyPoolMod,
      final double rFlatDodgeMod, final double PercentLifeStealMod,
      final double rFlatMPRegenModPerLevel, final double FlatMPPoolMod,
      final double rFlatGoldPer10Mod, final double FlatMovementSpeedMod,
      final double rPercentCooldownMod, final double rFlatMPModPerLevel,
      final double rPercentCooldownModPerLevel, final double PercentAttackSpeedMod,
      final double rPercentMagicPenetrationMod, final double PercentBlockMod,
      ...
      final double FlatMPRegenMod, final double rFlatTimeDeadMod,
      final double rFlatMagicDamageModPerLevel, final double FlatAttackSpeedMod,
      final double rFlatMagicPenetrationMod, final double rFlatCritChanceModPerLevel,
      final double PercentMPRegenMod, final double PercentDodgeMod, final double rFlatHPModPerLevel,
      final double PercentPhysicalDamageMod, final double rFlatDodgeModPerLevel,
      ...
      final double rFlatMagicPenetrationModPerLevel, final double FlatHPRegenMod,
      final double rFlatPhysicalDamageModPerLevel, final double rFlatEnergyRegenModPerLevel,
      final double FlatPhysicalDamageMod, final double rPercentTimeDeadMod,
      final double FlatCritDamageMod, final double rFlatArmorPenetrationMod,
      final double PercentArmorMod, final double PercentCritChanceMod,
      final double rFlatArmorPenetrationModPerLevel, final double rFlatArmorModPerLevel,
      final double rFlatHPRegenModPerLevel, final double rPercentTimeDeadModPerLevel,
      final double PercentEXPBonus, final double rFlatCritDamageModPerLevel,
      final double rFlatMovementSpeedModPerLevel, final double rPercentArmorPenetrationMod,
      final double rPercentArmorPenetrationModPerLevel, final double FlatEXPBonus,
      final double FlatHPPoolMod, final double FlatCritChanceMod, final double FlatArmorMod) {
