...
public final class SummonerEndpoints extends Endpoints {
   ...
   */
  public Summoner getByAccountId(final Region region, final String accountId) throws
      ExecutionException {
   ...
   */
  public Summoner getBySummonerId(final Region region, final String summonerId) throws
      ExecutionException {
    // This method is automatically generated and should not be modified directly.
