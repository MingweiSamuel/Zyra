...
public class LeaguePosition implements Serializable {
  ...
  public LeaguePosition(final boolean freshBlood, final boolean hotStreak, final boolean inactive,
      ...
      final MiniSeries miniSeries, final String position, final String queueType, final String rank,
      final String summonerId, final String summonerName, final String tier, final boolean veteran,
      final int wins) {
