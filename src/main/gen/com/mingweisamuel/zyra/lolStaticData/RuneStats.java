...
public class RuneStats implements Serializable {
  ...
  public RuneStats(final double PercentTimeDeadModPerLevel,
      final double PercentArmorPenetrationModPerLevel, final double PercentCritDamageMod,
      ...
      final double FlatEnergyRegenModPerLevel, final double FlatEnergyPoolMod,
      final double FlatMagicPenetrationModPerLevel, final double PercentLifeStealMod,
      final double FlatMPPoolMod, final double PercentCooldownMod,
      final double PercentMagicPenetrationMod, final double FlatArmorPenetrationModPerLevel,
      final double FlatMovementSpeedMod, final double FlatTimeDeadModPerLevel,
      final double FlatArmorModPerLevel, final double PercentAttackSpeedMod,
      final double FlatDodgeModPerLevel, final double PercentMagicDamageMod,
      final double PercentBlockMod, final double FlatDodgeMod, final double FlatEnergyRegenMod,
      final double FlatHPModPerLevel, final double PercentAttackSpeedModPerLevel,
      final double PercentSpellVampMod, final double FlatMPRegenMod, final double PercentHPPoolMod,
      final double PercentDodgeMod, final double FlatAttackSpeedMod, final double FlatArmorMod,
      final double FlatMagicDamageModPerLevel, final double FlatHPRegenMod,
      final double PercentPhysicalDamageMod, final double FlatCritChanceModPerLevel,
      final double FlatSpellBlockModPerLevel, final double PercentTimeDeadMod,
      final double FlatBlockMod, final double PercentMPPoolMod, final double FlatMagicDamageMod,
      final double PercentMPRegenMod, final double PercentMovementSpeedModPerLevel,
      final double PercentCooldownModPerLevel, final double FlatMPModPerLevel,
      final double FlatEnergyModPerLevel, final double FlatPhysicalDamageMod,
      final double FlatHPRegenModPerLevel, final double FlatCritDamageMod,
      final double PercentArmorMod, final double FlatMagicPenetrationMod,
      final double PercentCritChanceMod, final double FlatPhysicalDamageModPerLevel,
      final double PercentArmorPenetrationMod, final double PercentEXPBonus,
      final double FlatMPRegenModPerLevel, final double PercentMagicPenetrationModPerLevel,
      final double FlatTimeDeadMod, final double FlatMovementSpeedModPerLevel,
      final double FlatGoldPer10Mod, final double FlatArmorPenetrationMod,
      final double FlatCritDamageModPerLevel, final double FlatHPPoolMod,
