...
/**
 * BasicData - This object contains basic data.
 *
...
public class BasicData {
  ...
  public BasicData(final String colloq, final boolean consumeOnFull, final boolean consumed,
      final int depth, final String description, final List<String> from, final Gold gold,
      final String group, final boolean hideFromAll, final int id, final Image image,
      final boolean inStore, final List<String> into, final Map<String, Boolean> maps,
      final String name, final String plaintext, final String requiredChampion, final MetaData rune,
