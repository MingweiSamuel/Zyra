 ...
 *
 * This class was automatically generated from the <a href="https://developer.riotgames.com/api-methods/#lol-static-data-v3/GET_getSummonerSpellList">Riot API reference</a> on Mon Jun 05 20:58:07 PDT 2017. */
public class SummonerSpell implements Serializable {
  ...
  public SummonerSpell(final List<SpellVars> vars, final Image image, final String costBurn,
      ...
      final String description, final List<List<Double>> effect, final String key,
      final LevelTip leveltip, final List<String> modes, final String resource, final String name,
