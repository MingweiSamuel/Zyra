 ...
 *
 * Data is for a single summoner-champion combination (or summoner-all).
 */
public class AggregatedStats {
    ...
    public String toString() {
        return String.format("[agg.Stats KDA %d/%d/%d]", totalChampionKills, totalDeathsPerSession, totalAssists);
    }
}
