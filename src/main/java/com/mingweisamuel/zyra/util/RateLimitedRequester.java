...
public class RateLimitedRequester extends Requester {
    ...
    public RateLimitedRequester(String apiKey) {
        super(apiKey);
        rateLimits.put(TEN_SECONDS, TEN_SECONDS_DEFAULT_LIMIT - 1);
        rateLimits.put(TEN_MINUTES, TEN_MINUTES_DEFAULT_LIMIT - 1);
    }
    ...
    public RateLimitedRequester(String apiKey, Map<Long, Integer> rateLimits, AsyncHttpClient client) {
        super(apiKey, client);
        rateLimits.putAll(rateLimits);
    }
    ...
    private CompletableFuture<Response> getRequestRateLimitedAsyncInternal(
        ...
        return limiter.acquireAsync()
                ...
                .thenCompose(r -> {
                    ...
                    if (r.getStatusCode() == 200 || r.getStatusCode() == 404)
                    ...
                    if (r.getStatusCode() != 429 && r.getStatusCode() < 500 || retries >= RETRIES_429) {
